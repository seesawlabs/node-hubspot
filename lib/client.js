...
a
  ...
  var emails = {
    singleSend: function(options, cb) {
      request.post(
      {
        url:'http://api.hubapi.com/email/public/v1/singleEmail/send?hapikey=' + self.key,
        body: data,
        json: true
      }, cb);
      ...
      // sendRequest({
      //   method: 'POST',
      //   url: self.baseUrl + '/email/public/v1/singleEmail/send?hapikey=' + self.key,
      //   body: data
      // }, cb);
    }
  };
